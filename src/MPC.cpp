...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars) {
      ...
      //The coeficients 1000, 5, 200, 10 represent the attention we give to this attributes (cte_start,epsi_start)
      for (int i = 0; i < N; i++) {
      ...
      //Determinate how smooth the actuations are
      for (int i = 0; i < N - 2; i++) {
      ...
      //Add 1 to each attributes because the cost function is fg[0] = 0
      ...
      for (int i = 0; i < N -1; i++){
        ...
        //Calculate value in t_1 refers to t
